...
@Component({
  selector: 'app-editroomlocationconfirmation',
  templateUrl: './editroomlocationconfirmation.component.html',
  styleUrl: './editroomlocationconfirmation.component.css'
})
export class EditroomlocationconfirmationComponent {
