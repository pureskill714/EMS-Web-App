...
export class ManageRoomsComponent {
  ...
  addMeetingRoom() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      this.http.post("http://34.30.66.94/api/addmeetingrooms", bodyData).subscribe(
          (resultData: any) => {
              console.log(resultData);
  ...
  editRoomOrder(roomId: string, meetingRoomName: string) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result === 'confirm') {
        ...
        this.http.post("http://34.30.66.94/api/editmeetingroomorder", bodyData).subscribe(
          (resultData: any) => {
              console.log(resultData);
              //alert("Room Booking Successfully");
  ...
  editRoomCapacity(roomId: string, meetingRoomName: string) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result === 'confirm') {
        ...
        this.http.post("http://34.30.66.94/api/editmeetingroomcapacity", bodyData).subscribe(
          (resultData: any) => {
              console.log(resultData);
              //alert("Room Booking Successfully");
  ...
  editRoomLocation(roomId: string, meetingRoomName: string) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result === 'confirm') {
        ...
        this.http.post("http://34.30.66.94/api/editmeetingroomlocation", bodyData).subscribe(
          (resultData: any) => {
              console.log(resultData);
              //alert("Room Booking Successfully");
  ...
  editRoomName(roomId: string, oldMeetingRoomName: string) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result === 'confirm') {
        ...
        this.http.post("http://34.30.66.94/api/editmeetingroomname", bodyData).subscribe(
          (resultData: any) => {
              console.log(resultData);
              //alert("Room Booking Successfully");
  ...
  deleteMeetingRoom(roomId: string, meetingRoomName: string) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result === 'confirm') {
        ...
        this.http.post("http://34.30.66.94/api/deletemeetingrooms", bodyData).subscribe(
          (resultData: any) => {
              console.log(resultData);
              //alert("Room Booking Successfully");
