...
export class ManageRoomsComponent {
  ...
  addMeetingRoom() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      this.http.post("http://192.168.10.110:9992/addmeetingrooms", bodyData).subscribe(
          (resultData: any) => {
              console.log(resultData);
  ...
  editRoomOrder(roomId: string, meetingRoomName: string) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result === 'confirm') {
        ...
        this.http.post("http://192.168.10.110:9992/editmeetingroomorder", bodyData).subscribe(
          (resultData: any) => {
              console.log(resultData);
              //alert("Room Booking Successfully");
  ...
  editRoomCapacity(roomId: string, meetingRoomName: string) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result === 'confirm') {
        ...
        this.http.post("http://192.168.10.110:9992/editmeetingroomcapacity", bodyData).subscribe(
          (resultData: any) => {
              console.log(resultData);
              //alert("Room Booking Successfully");
  ...
  editRoomLocation(roomId: string, meetingRoomName: string) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result === 'confirm') {
        ...
        this.http.post("http://192.168.10.110:9992/editmeetingroomlocation", bodyData).subscribe(
          (resultData: any) => {
              console.log(resultData);
              //alert("Room Booking Successfully");
  ...
  editRoomName(roomId: string, oldMeetingRoomName: string) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result === 'confirm') {
        ...
        this.http.post("http://192.168.10.110:9992/editmeetingroomname", bodyData).subscribe(
          (resultData: any) => {
              console.log(resultData);
              //alert("Room Booking Successfully");
