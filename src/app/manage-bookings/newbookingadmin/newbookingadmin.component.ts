...
@Component({
  ...
  templateUrl: './newbookingadmin.component.html',
  styleUrl: './newbookingadmin.component.css'
})
export class NewbookingadminComponent implements OnInit {
  ...
  search(): void {
    ...
    this.http.post<any>('http://192.168.10.110:9992/retrievebookingtimeslots', bodyData)
      .subscribe(
        (resultData: any) => {
          console.log(resultData);
      ...
      this.http.post<any>('http://192.168.10.110:9992/retrievecalendardetails', bodyData)
      .subscribe(
        (resultData: any) => {
          console.log(resultData);
    ...
    if (this.selectedTimeSlots.length === 0) {
      ...
      dialogRef.afterClosed().subscribe(result => {
        if (result === 'confirm') {
          ...
          this.http.post("http://192.168.10.110:9992/booking", bodyData).subscribe(
          (resultData: any) => {
              console.log(resultData);
