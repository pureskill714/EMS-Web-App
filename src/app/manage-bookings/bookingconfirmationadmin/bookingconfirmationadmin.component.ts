...
@Component({
  selector: 'app-bookingconfirmationadmin',
  templateUrl: './bookingconfirmationadmin.component.html',
  styleUrl: './bookingconfirmationadmin.component.css'
})
export class BookingconfirmationadminComponent {
