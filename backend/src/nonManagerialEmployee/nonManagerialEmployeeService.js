...
function sendVerificationEmail(email, verificationToken) {
    return new Promise((resolve, reject) => {
        ...
        const mailOptions = {
            ...
            html: `Click <a href="http://34.30.66.94/verify/${verificationToken}">here</a> to verify your account.`
        };
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <a href="http://34.30.66.94/reset-password/${resetToken}" class="button">Reset Password</a>
