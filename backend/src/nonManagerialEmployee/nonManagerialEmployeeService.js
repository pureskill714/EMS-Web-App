...
function sendVerificationEmail(email, verificationToken) {
    return new Promise((resolve, reject) => {
        ...
        const mailOptions = {
            ...
            html: `Click <a href="http://58.182.172.239/api/verify/${verificationToken}">here</a> to verify your account.`
        };
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <a href="http://58.182.172.239/api/reset-password/${resetToken}" class="button">Reset Password</a>
